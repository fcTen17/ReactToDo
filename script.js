...
class ToDoList extends React.Component {
  ...
  toggleComplete(id, completed) {
    ...
    fetch(`https://altcademy-to-do-list-api.herokuapp.com/tasks/${id}/mark_${newState}?api_key=141`, {
      method: "PUT",
      mode: "cors",
    }).then(checkStatus)
      .then(json)
  ...
  handleSubmit(event) {
    ...
    fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=141", {
      method: "POST",
      mode: "cors",
  ...
  deleteTask(id) {
    ...
    fetch(`https://altcademy-to-do-list-api.herokuapp.com/tasks/${id}?api_key=141`, {
      method: "DELETE",
      mode: "cors",
    }).then(checkStatus)
      .then(json)
